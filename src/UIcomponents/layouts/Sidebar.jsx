...
import { ModalHiddenContext, ShowTweetModalContext, TweetModalContext } from 'context/ModalContext'
				...
				<div className={`${style.sideBarGroup}`}>
					<div className={`${style.sideBarItems}`}>
						...
						<div className={`${style.iconGroup}`}>
							<SideItem styleName={step === 1 ? 'actionHome' : 'iconHome'} itemName='首頁' page='home' iconName={step === 1 ? 'onName' : 'itemName'}/>
							<SideItem
								styleName='iconTweet'
								itemName='推文'
								customName='custom'

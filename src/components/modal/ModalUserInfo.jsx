    ...
    <div className={`${style.userInfoMdContainer}`}>
      <header className={`${style.userInfoMdHeader}`}>
        <nav className={`${style.userInfoMdNavbar}`}>
          <div className={`${style.userInfoMdTitle}`}>
            <h1 className={`${style.userInfoMdArrow}`}><Arrow /></h1>
            <h1 className={`${style.userInfoClose}`}><Close style={{ color: '#ff6600' }} /></h1>
            <h1>編輯個人資料</h1>
          </div>
      ...
      <div className={`${style.userInfoMdImgGroup}`}>
        <div className={`${style.userInfoIcon}`}>
          <p className={`${style.userInfoMdWhite}`}><WhiteCamera /></p>
          <p className={`${style.userInfoMdWhite}`}><WhiteX /></p>
        </div>
        <div className={`${style.userInfoMdBackground}`}>
          <img src={data[0].background} className={`${style.userInfoMdCardImg}`} alt='' />
        </div>
        <div className={`${style.userInfoSecIcon}`}>
          <p className={`${style.userInfoMdWhite}`}><WhiteCamera /></p>
        </div>
        <div className={`${style.userInfoMdAvatar}`}>
          <img src={data[0].avatar} className={`${style.userInfoMdImgAvatar}`} alt='' />
        </div>
      </div>
